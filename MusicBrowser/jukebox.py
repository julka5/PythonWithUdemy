...
class Scrollbox(tkinter.Listbox):  # creating a class listbox with a scroll
...
class DataListBox(Scrollbox):
    ...
    def requery(self, link_value=None):
        self.link_value = link_value  # storing the id of an artist
        ...
        # clear the listbox contents before re_loading
        self.clear()
    ...
    def on_select(self, event):
        if self.linked_box:
            ...
            if self.curselection():  # that's because of problems with windows, see:
                # https://www.udemy.com/python-the-complete-python-developer-course/learn/v4/questions/2279950
                index = self.curselection()[0]
                value = self.get(index),

                if self.link_value:
                    value = value[0], self.link_value  # remember it is a tuple
...
if __name__ == "__main__":
    ...
    albumLV.set(("Choose an artist",))  # need two parenthesis because we are passing a tuple
    ...
    songLV.set(("Choose an album",))
    songList = DataListBox(mainWindow, conn, "songs", "title", ("track", ))
    # songList.requery()
